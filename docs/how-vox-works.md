...
vox organizes public material by the job it can perform:

| Material | What it can help establish |
| --- | --- |
| Direct material | What a participant published, said, or did in public. |
| Independent context | Reporting, records, analysis, or informed explanation that can support factual context. |
| Public reaction | The reasons, interpretations, and positions visible in the retrieved discussion. |
| Background reference | Older material that explains history, terms, or prior events. |
...
The Story distinguishes two questions:

1. What does the available evidence support?
2. How do people in the retrieved public discussion interpret the situation?
...
The first view is compact. It gives the reader enough context to decide whether to continue. A fuller view can explain perspectives, reasons, timeline, sources, related Stories, and material changes.
...
vox is designed not to:

- treat a search result as proof;
- treat an official label as automatic authority;
- turn likes or repetition into factual support;
- claim that a partial sample represents a whole population;
- force every disagreement into two camps;
